...
from training.model import VisionTransformer
import pathlib
...
from monkey_patch_forward import replace_qwen2_5_with_mixed_modality_forward, replace_qwen_2_with_mixed_modality_forward, \
    replace_custom_qwen2_5_with_mixed_modality_forward
import deepspeed
from model import Qwen2_5_Custom_Vit
import sys
sys.path.append("./")
...
def train():
    ...
    replace_custom_qwen2_5_with_mixed_modality_forward(use_liger=training_args.use_liger)
    ...
    elif "qwen2_5" in model_args.model_id:
        model = Qwen2_5_Custom_Vit.from_pretrained(model_args.model_id,
            torch_dtype=compute_dtype,
            attn_implementation="flash_attention_2" if not training_args.disable_flash_attn2 else "sdpa", 
            **bnb_model_from_pretrained_args
        )
    ...
    processor = Qwen2_5_VLProcessor.from_pretrained(model_args.model_id, padding_side="right")
